		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App1",
									"targetURL": "#vcd94xt10zapp1fioriapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcd94xt10zapp1fioriapp1-display": {
								"semanticObject": "vcd94xt10zapp1fioriapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcd94xt10z.app1.fioriapp1",
									"url": sap.ui.require.toUrl("vcd94xt10z/app1/fioriapp1")
								}
							}
						}
					}
